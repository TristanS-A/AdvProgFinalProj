...
How to run the game: You have to drag the image, music, ect... files into the debug folder and this will also be where the results file is generated. Also, you must run the CMakeLists.txt file first to add SDL. 
